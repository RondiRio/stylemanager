...
$stmt = $pdo->prepare("
    SELECT
        v.id, v.valor, v.data, v.descricao, v.status, v.data_aprovacao,
                    ...
                    <tbody>
                        ...
                        <tr data-status="<?php echo $v['status']; ?>" data-profissional="<?php echo strtolower($v['profissional_nome']); ?>">
                            <td>
                                ...
                                <?php echo date('d/m/Y', strtotime($v['data'])); ?>
                            </td>
                            <td>
                            ...
                            <td>
                                <?php if ($v['descricao']): ?>
                                    <span class="text-muted"><?php echo htmlspecialchars($v['descricao']); ?></span>
                                <?php else: ?>
