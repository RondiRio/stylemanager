...
$stmt = $pdo->prepare("
    SELECT
        g.id, g.valor, g.data, g.observacoes, g.status, g.motivo_negacao, g.data_aprovacao,
            ...
            <div class="table-responsive">
                <table class="table table-hover" id="tabelaGorjetas">
                    ...
                    <tbody>
                        ...
                        <tr data-status="<?php echo $g['status']; ?>" data-profissional="<?php echo strtolower($g['profissional_nome']); ?>" data-data="<?php echo $g['data']; ?>">
                            <td>
                                <i class="fas fa-calendar me-1 text-muted"></i>
                                <?php echo date('d/m/Y', strtotime($g['data'])); ?>
                            </td>
                            <td>
